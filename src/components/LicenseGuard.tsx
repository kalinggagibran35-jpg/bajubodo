...
export default function LicenseGuard({ children }: LicenseGuardProps) {
  ...
  useEffect(() => {
    // Initialize protections when license is valid
    if (status === 'valid') {
      initProtection();
    }
  }, [status]);
  ...
  function checkLicense(): void {
    ...
    // If Supabase is not configured, skip license check (development mode)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Baju Bodo POS</h1>
          <p className="text-gray-400">Sistem Kasir Profesional untuk Baju Tradisional Bugis Makassar</p>
        </div>
        ...
        <div className="text-center space-y-3">
          <p className="text-gray-500 text-sm">
            Belum punya lisensi? Hubungi kami di <span className="text-yellow-400">WhatsApp: 085298328159</span>
          </p>
          <button
      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-800/80 backdrop-blur rounded-2xl p-8 border border-red-500/30 shadow-2xl text-center">
          ...
          <p className="text-gray-500 text-sm mt-4">
            Hubungi <span className="text-yellow-400">WhatsApp: 085298328159</span> untuk perpanjangan
          </p>
        </div>
      </div>
    </div>
